                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="name" class="form-control" name="name" value="{{$expense->name}}" required/>
                                        ...
                                        <div class="col-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="number" id="amount" class="form-control" name="amount" value="{{$expense->amount}}" required/>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="note" class="form-control" name="note" value="{{$expense->note}}"/>
