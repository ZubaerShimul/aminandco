...
@section('content')
    <div class="content-wrapper">
        @include('widgets.breadcrumb', ['title' => __('Bank Account Management'), 'subtitle'=> __('Bank Account'), 'button' => '<a type="button" class="btn btn-primary" href="'.route('account.create').'">'. __('Add New') .'</a>'])
        <div class="content-body">
            <section class="app-user-list">
                <!-- list and filter start -->
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">@lang('Bank Account')</h4>
                    </div>
