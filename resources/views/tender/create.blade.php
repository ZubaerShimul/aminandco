                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('Tender create')}}</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{route('tender.store')}}" method="post" class="form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <label class="form-label" for="name">@lang('Tender No.') <span class="text-danger">*</span></label>
                                                <input type="text" id="name" class="form-control" name="tender_no" value="{{old('tender_no')}}"/>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="working_time" class="form-control" name="working_time" value="{{old('working_time')}}" placeholder="@lang("How many days")"/>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="number" id="budget" class="form-control" name="budget" value="{{old('budget')}}" placeholder="@lang("Enter only number")"/>
                                        ...
                                        {{--  <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="number" id="opening_amount" class="form-control" name="opening_amount" value="{{old('opening_amount')}}" placeholder="@lang("Enter only number")"/>
