...
<head>
    ...
    <title>Amin & CO Report Print</title>
                ...
                <div class="invoice-print p-3">
                    <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                        <div>
                            <div class="d-flex mb-1">
                                ...
                                <h3 class="text-primary fw-bold ms-1"><bold>Amin & CO</bold></h3>
                            </div>
                            <p class="mb-25">1 No. Custom Ghat Road, Punak market, Khulna</p>
                        </div>
                        <div class="mt-md-0 mt-2">
                            <h4 class="fw-bold text-end mb-1">Tender No #{{ $tender->tender_no }}</h4>
                            <div class="invoice-date-wrapper mb-50">
                                <span class="invoice-date-title">From:</span>
                                <span class="fw-bold"> {{ $tender->start_date }}</span>
                            </div>
                            <div class="invoice-date-wrapper">
                                <span class="invoice-date-title">To:</span>
                                <span class="fw-bold">{{ $tender->end_date }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pb-2">
                        ...
                        <div class="col-sm-6 mt-sm-0 mt-2">
                            <h6 class="mb-1">Tender Details:</h6>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="pe-1">Tender Name:</td>
                                        <td><strong>{{ $tender->name }}</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">District:</td>
                                        <td>{{ $tender->district_name }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Working Time:</td>
                                        <td>{{ $tender->working_time }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Budget:</td>
                                        <td>{{ $tender->budget }} BDT</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Amount Received:</td>
                                        <td>{{ $data['payment'] }} BDT</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Amount Expenses:</td>
                                        <td>{{ $data['expense'] }} BDT</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    <!-- Bank Information -->
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="mb-25">Bank Name: <strong>{{ $tender->account ? $tender->account->name : ''}}</strong></p>
                            <p class="mb-25">Account Number: {{ $tender->account ? $tender->account->account_number : '' }}</p>
                            <p class="mb-25">Branch: {{$tender->account ? $tender->account->branch : '' }}</p>
