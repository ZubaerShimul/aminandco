                ...
                <div class="invoice-print p-3">
                    <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                        ...
                        <div class="mt-md-0 mt-2">
                            <h4 class="fw-bold text-end mb-1">@lang("Official Expense Report")</h4>
                            @if(!empty($from_date))
                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">                                            
                                            <thead>
                                                <tr>
                                                    <th class="py-1">@lang("SL No.")</th>
                                                    <th class="py-1">@lang("Date")</th>
                                                    <th class="py-1">@lang("Description")</th>
                                            ...
                                            @if(isset($expenses[0]))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="card-text fw-bold mb-25">{{ $ex->date}}</p>
                                                        </td>
                                                        <td>
                                                            <p class="card-text fw-bold mb-25">{{ $ex->description}}</p>
                                                        </td>
                                                        <td class="py-1">
