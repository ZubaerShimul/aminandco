                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="date" id="date" class="form-control" name="date" value="{{Carbon\Carbon::now()->toDateString()}}" {{ Auth::user()->is_admin ? "" : 'readonly' }}required/>
                                        ...
                                        <div class="col-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="number" id="total" class="form-control" name="total" value="{{old('total')}}" readonly/>
